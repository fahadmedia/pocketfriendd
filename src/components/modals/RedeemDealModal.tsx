...
const RedeemDealModal = ({ isOpen, onClose }: RedeemDealModalProps) => {
                    ...
                    >
                        <div className="card-premium max-w-lg w-full mx-4 p-8 pointer-events-auto relative">
                            ...
                            <motion.div
                                ...
                                className="w-16 h-16 mx-auto mb-6 rounded-full bg-gradient-to-br from-orange-500 to-primary flex items-center justify-center"
                            >
                            ...
                            >
                                This deal is available on mobile only
                            </motion.h2>
                            ...
                            >
                                <p className="text-foreground/80 mb-2">
                                    To redeem this discount, please download the Pocket Friend mobile app.
                                </p>
                                <p className="text-foreground/80">
                                    It's quick, free, and gives you the full experience.
                                </p>
                            </motion.div>
